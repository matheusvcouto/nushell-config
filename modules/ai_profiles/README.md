...
IA, sem conflito de sessão. Dois comandos cobrem qualquer CLI configurada
...
## Rodar a CLI com um perfil

```
ai-profile run <tool> <nome> ...args
```
...
ai-profile run claude mae
ai-profile agy new mae
ai-profile run agy mae --print "oi"
ai-profile claude rename mae monica
```

Na primeira vez que você roda `ai-profile run <tool> <nome>`, a CLI não tem
